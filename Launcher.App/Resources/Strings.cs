...
public static class Strings
{
    ...
    public static string Settings_FontSection => Get(nameof(Settings_FontSection));
    public static string Settings_FontSelectionLabel => Get(nameof(Settings_FontSelectionLabel));
    public static string Settings_FontMicrosoftYaHeiUITitle => Get(nameof(Settings_FontMicrosoftYaHeiUITitle));
    public static string Settings_FontMicrosoftYaHeiTitle => Get(nameof(Settings_FontMicrosoftYaHeiTitle));
    public static string Settings_FontSimHeiTitle => Get(nameof(Settings_FontSimHeiTitle));
    public static string Settings_FontSimSunTitle => Get(nameof(Settings_FontSimSunTitle));
    public static string Settings_FontDengXianTitle => Get(nameof(Settings_FontDengXianTitle));
    public static string Settings_FontKaiTiTitle => Get(nameof(Settings_FontKaiTiTitle));
    public static string Settings_FontFangSongTitle => Get(nameof(Settings_FontFangSongTitle));
    public static string Settings_FontSegoeUITitle => Get(nameof(Settings_FontSegoeUITitle));
    public static string Settings_FontArialTitle => Get(nameof(Settings_FontArialTitle));
    public static string Settings_FontTimesNewRomanTitle => Get(nameof(Settings_FontTimesNewRomanTitle));
    public static string Settings_FontConsolasTitle => Get(nameof(Settings_FontConsolasTitle));
